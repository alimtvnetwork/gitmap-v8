...
| Field       | Value                                              |
|-------------|----------------------------------------------------|
| GitHub Repo | `alimtvnetwork/gitmap-v7`                 |
...
```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v7/main/gitmap/scripts/install.sh | bash
```

### Version-Pinned

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v7/main/gitmap/scripts/install.sh | bash -s -- --version v2.55.0
```

### Custom Directory

```bash
curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v7/main/gitmap/scripts/install.sh | bash -s -- --dir /opt/gitmap --version v2.55.0
```
