...
|-------------------|------------------------------------------------------------------------------------------------------------------------------------------------|--------------------------------------------------------------------------------------------------------------------------------------------|
| Install (default) | `irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v7/main/gitmap/scripts/install.ps1 \| iex`                                         | `curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v7/main/gitmap/scripts/install.sh \| sh`                                |
| Install (prompt)  | `irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v7/main/install-quick.ps1 \| iex`                                                  | `curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v7/main/install-quick.sh \| bash`                                       |
...
| Uninstall         | `irm https://raw.githubusercontent.com/alimtvnetwork/gitmap-v7/main/uninstall-quick.ps1 \| iex`                                                | `curl -fsSL https://raw.githubusercontent.com/alimtvnetwork/gitmap-v7/main/uninstall-quick.sh \| bash`                                     |
