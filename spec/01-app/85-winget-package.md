...
PackageName: GitMap
PackageUrl: https://github.com/alimtvnetwork/gitmap-v7
License: MIT
LicenseUrl: https://github.com/alimtvnetwork/gitmap-v7/blob/main/LICENSE
...
Installers:
  - Architecture: x64
    InstallerUrl: https://github.com/alimtvnetwork/gitmap-v7/releases/download/v2.49.1/gitmap-v4.49.1-windows-amd64.zip
    InstallerSha256: <SHA256_OF_ZIP>
  - Architecture: arm64
    InstallerUrl: https://github.com/alimtvnetwork/gitmap-v7/releases/download/v2.49.1/gitmap-v4.49.1-windows-arm64.zip
    InstallerSha256: <SHA256_OF_ZIP>
...
2. **Generate manifests (interactive):**
   ```powershell
   wingetcreate new https://github.com/alimtvnetwork/gitmap-v7/releases/download/v2.49.1/gitmap-v4.49.1-windows-amd64.zip
   ```
...
wingetcreate update AliMTVNetwork.GitMap --version 2.49.1 \
  --urls https://github.com/alimtvnetwork/gitmap-v7/releases/download/v2.49.1/gitmap-v4.49.1-windows-amd64.zip \
...
- name: Publish to Winget
  ...
  run: |
    wingetcreate update AliMTVNetwork.GitMap \
      ...
      --urls "https://github.com/alimtvnetwork/gitmap-v7/releases/download/${{ github.ref_name }}/gitmap-${{ github.ref_name }}-windows-amd64.zip" \
