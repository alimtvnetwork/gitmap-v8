...
**Scope:** Generic. Applies to any project whose repo name ends in a `-v<N>` suffix (e.g. `gitmap-v7`, `myapp-v7`, `cli-tool-v12`).
...
This guarantees a stale install URL (e.g. someone bookmarked `gitmap-v7` years ago) still pulls the user onto the latest major repo line without manual intervention.
...
| Input URL                                          | stem        | N  |
|----------------------------------------------------|-------------|----|
| `https://github.com/alimtvnetwork/gitmap-v7`       | `gitmap`    | 3  |
...
```
  [discovery] baseline: alimtvnetwork/gitmap-v7
  [discovery] probe ceiling: 30
  [discovery] HEAD https://github.com/alimtvnetwork/gitmap-v7 ... HIT
  [discovery] HEAD https://github.com/alimtvnetwork/gitmap-v7 ... MISS (fail-fast)
  [discovery] effective: alimtvnetwork/gitmap-v7
  [discovery] delegating to https://raw.githubusercontent.com/alimtvnetwork/gitmap-v7/main/install-quick.sh
```

The user transparently lands on `gitmap-v7` even though they invoked `gitmap-v7`.
