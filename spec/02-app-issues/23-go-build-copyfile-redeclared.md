...
cmd/installvscode.go:11:2: "github.com/alimtvnetwork/gitmap-v7/gitmap/constants" imported and not used
```
...
`installvscode.go` imported `github.com/alimtvnetwork/gitmap-v7/gitmap/constants` but never
