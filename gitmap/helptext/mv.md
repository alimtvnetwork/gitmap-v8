...
**Output:**
    ...
    [mv] resolving LEFT : ./gitmap-v7 (folder)
    [mv] resolving RIGHT : ./gitmap-v7 (folder)
...
**Output:**
    ...
    [mv] resolving RIGHT : https://github.com/owner/gitmap-v7
    [mv]   -> mapped to working folder: /work/gitmap-v7
    [mv]   -> folder does not exist; cloning
    [mv]   -> clone OK
    [mv] copying files LEFT -> RIGHT (excluding .git/) ...
    [mv]   copied 142 files
    [mv] committing in https://github.com/owner/gitmap-v7 ...
    [mv]   commit a1b2c3d "gitmap mv from ./gitmap-v7"
    [mv] pushing https://github.com/owner/gitmap-v7 ...
    [mv]   push OK
    [mv] done
