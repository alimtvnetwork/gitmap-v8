...
const TerminalPreview = () => (
  <div className="rounded-lg border border-border overflow-hidden my-6">
    <div className="bg-terminal px-4 py-2 flex items-center gap-2 border-b border-border">
      ...
      <span className="text-xs font-mono text-muted-foreground ml-2">gitmap mv ./gitmap-v7 https://github.com/owner/gitmap-v7</span>
    </div>
    <div className="bg-terminal p-4 font-mono text-xs leading-relaxed overflow-x-auto">
      <div className="text-terminal-foreground">[mv] resolving RIGHT : https://github.com/owner/gitmap-v7</div>
      <div className="text-terminal-foreground">[mv]   -&gt; mapped to working folder: /work/gitmap-v7</div>
      ...
      <div className="text-terminal-foreground">[mv] committing in https://github.com/owner/gitmap-v7 ...</div>
      <div className="text-terminal-foreground">[mv]   commit a1b2c3d "gitmap mv from ./gitmap-v7"</div>
      <div className="text-terminal-foreground">[mv] pushing https://github.com/owner/gitmap-v7 ...</div>
...
gitmap mv ./gitmap-v7 https://github.com/owner/gitmap-v7
